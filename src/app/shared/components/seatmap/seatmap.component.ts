...
export class SeatmapComponent implements OnInit, OnChanges {
  @Input() seatMapData: any;
  @Input() isInFlightCall: any;
  ...
  createCheckInSeatMapData(passengersData: any, indexOfRow: any, indexOfSeat: any) {
    ...
    this.seatList[indexOfRow].seats[indexOfSeat].forEach((element: any, index: any) => {
  ...
  createInflightSeatMapData(passengersData: any, indexOfRow: any, indexOfSeat: any) {
  ...
  checkAndPushKeysInSeatList(passengersData: any, indexOfRow: any, indexOfSeat: any, keyToCheck: any) {
  ...
  clickOnseat(seat: any, row: any, seatData: any) {
  ...
  isSeatContainspassenger(seat: any) {
